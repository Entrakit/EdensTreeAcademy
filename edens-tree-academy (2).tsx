...
const EdenTreeAcademy = () => {
  ...
  const blogPosts = [
    { 
      title: 'Understanding Telesis',
      date: 'Nov 20, 2024',
      excerpt: 'Explore the concept of purposeful development and divine direction in spiritual growth.',
      readTime: '5 min read',
      category: 'Spirituality'
    },
    { 
      title: 'The Path of Christian Mysticism',
      date: 'Nov 18, 2024',
      excerpt: 'Discover the ancient practices and modern applications of mystical Christian traditions.',
      readTime: '7 min read',
      category: 'Mysticism'
    },
    { 
      title: 'Meditation and Divine Connection',
      date: 'Nov 15, 2024',
      excerpt: 'Learn how meditation can deepen your spiritual practice and strengthen your connection with the divine.',
      readTime: '6 min read',
      category: 'Practice'
    },
    { 
      ...
      date: 'Nov 12, 2024',
      excerpt: 'Delve into the metaphysical understanding of consciousness and its role in spiritual awakening.',
      readTime: '8 min read',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-blue-50">
      ...
      <section className="py-16 bg-green-50/50">
        <div className="container mx-auto px-4">
          <h2 className="font-serif text-4xl text-center text-green-900 mb-12">
            Latest Insights
          </h2>
              ...
              <Card key={post.title} className="hover:shadow-lg transition-shadow">
                <CardContent className="p-6">
                  <div className="flex justify-between items-center mb-2">
                    <span className="text-sm text-green-600">{post.date}</span>
                    <span className="text-sm text-green-700 bg-green-100 px-2 py-1 rounded-full">
                      {post.category}
                    </span>
                  </div>
                  <h3 className="font-serif text-2xl text-green-800 mb-3">{post.title}</h3>
          ...
          <div className="text-center mt-8">
            <button className="bg-green-700 text-white px-6 py-2 rounded-full hover:bg-green-600 transition-colors">
              View All Articles
            </button>
          </div>
        </div>
